...
<content>
    <style type="text/css">
        table tr td:nth-child(even) { width: 25%; } table tr td:nth-child(odd)
        { width: 5%; } hr { margin: 0 5px 8px; }
    </style>
    ...
    <script type="text/javascript">
        ...
        ref.refresh = function(text) {++updating;
            try {
    ...
    <div id="cstats" class="box">
        <div class="heading">
            24小时 IP流量历史 &nbsp;
            <div class="spinner" id="refresh-spinner" style="visibility:hidden;" onclick="debugTime=1">
            </div>
            <a href="#" data-toggle="tooltip" onclick="ref.toggleX(); return false;"
            title="自动刷新视图" class="pull-right" id="refresh-but">
                <i class="icon-refresh">
                </i>
            </a>
        </div>
        <div class="content">
            <div id="tab-area" class="btn-toolbar">
            </div>
            <script type="text/javascript">
            ...
            <div id="bwm-controls">
                ...
                :
                <a href="javascript:switchHours(1);" id="hr1">
                    1
                </a>
                ,
                <a href="javascript:switchHours(2);" id="hr2">
                    2
                </a>
                ,
                <a href="javascript:switchHours(4);" id="hr4">
                    4
                </a>
                ,
                <a href="javascript:switchHours(6);" id="hr6">
                    6
                </a>
                ,
                <a href="javascript:switchHours(12);" id="hr12">
                    12
                </a>
                ,
                <a href="javascript:switchHours(18);" id="hr18">
                    18
                </a>
                ,
                <a href="javascript:switchHours(24);" id="hr24">
                    24
                </a>
                |
                <b>
                ...
                :
                <a href="javascript:switchAvg(1)" id="avg1">
                    Off
                </a>
                ,
                <a href="javascript:switchAvg(2)" id="avg2">
                    2x
                </a>
                ,
                <a href="javascript:switchAvg(4)" id="avg4">
                    4x
                </a>
                ,
                <a href="javascript:switchAvg(6)" id="avg6">
                    6x
                </a>
                ,
                <a href="javascript:switchAvg(8)" id="avg8">
                    8x
                </a>
                |
                <b>
                ...
                :
                <a href="javascript:switchScale(0)" id="scale0">
                    全部
                </a>
                或
                <a href="javascript:switchScale(1)" id="scale1">
                    单个
                </a>
                |
                <b>
                ...
                :
                <a href="javascript:switchDraw(0)" id="draw0">
                    填充
                </a>
                or
                <a href="javascript:switchDraw(1)" id="draw1">
                    实线
                </a>
                |
                <b>
                ...
                <small>
                    <a href="javascript:switchColor(1)" id="drawrev">
                        [反转]
                    </a>
                </small>
                |
                <a class="ajaxload" href="admin-bwm.asp">
                    <b>
                        配置
                    </b>
                </a>
            ...
            <table id="txt" class="data-table bwm-info">
                <tr>
                    <td>
                        <b style="border-bottom:blue 1px solid" id="rx-name">
                            下行
                        </b>
                ...
                <tr>
                    <td>
                        <b style="border-bottom:blue 1px solid" id="tx-name">
                            上行
                        </b>
            ...
            <script type="text/javascript">
                $('#settings').forms([{
                    title: '当前的IP',
                    name: 'f_ipt_addr_shown',
                    type: 'select',
                    options: [[0, '选择']],
                    suffix: '&nbsp; <small>(从此列表中单击/选择设备以将其隐藏)</small>'
                },
                {
                    title: '隐藏的IP',
                    name: 'f_ipt_addr_hidden',
                    type: 'select',
                    options: [[0, '选择']],
                    suffix: '&nbsp; <small>(单击/选择以再次显示)</small>'
                }]);
            </script>
            <span id="dtime">
            </span>
            <div class="alert alert-warning" style="display:none" id="rbusy">
                程序忙或没有响应. 几秒钟后重新加载.
            </div>
        </div>
    </div>
