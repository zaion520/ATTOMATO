	...
	<script type="text/javascript">
		...
		for (var uidx = 0; uidx < wl_ifaces.length; ++uidx) {
			if (wl_sunit(uidx)<0) {
				...
				htmlOut += ('<div class="box"><div class="heading">无线设置 ');
				...
				htmlOut += createFormFields([
					{ title: '博通802.11G无线技术', name: 'wl'+u+'_afterburner', type: 'select', options: [['auto','自动'],['on','启用'],['off','禁用 *']],
					value: nvram['wl'+u+'_afterburner'] },
					{ title: 'AP隔离', name: 'wl'+u+'_ap_isolate', type: 'select', options: [['0','禁用 *'],['1','启用']],
					...
					{ title: '信道间隔', name: 'wl'+u+'_bcn', type: 'text', maxlen: 5, size: 7,
					suffix: ' <small>(范围: 1 - 65535; 默认: 100)</small>', value: nvram['wl'+u+'_bcn'] },
					{ title: 'CTS保护模式', name: 'wl'+u+'_gmode_protection', type: 'select', options: [['off','禁用 *'],['auto','自动']],
					value: nvram['wl'+u+'_gmode_protection'] },
					{ title: '监管模式', name: 'wl'+u+'_reg_mode', type: 'select',
					options: [['off', '关闭 *'],['d', '802.11d'],['h', '802.11h']],
					...
					suffix: ' <small>米</small>&nbsp;&nbsp;<small>(范围: 0 - 99999; 0 = 默认)</small>',
					value: (nvram['wl'+u+'_distance'] == '') ? '0' : nvram['wl'+u+'_distance'] },
					{ title: 'DTIM间隔', name: 'wl'+u+'_dtim', type: 'text', maxlen: 3, size: 5,
					suffix: ' <small>(范围: 1 - 255; 默认: 1)</small>', value: nvram['wl'+u+'_dtim'] },
					{ title: '分段阈值', name: 'wl'+u+'_frag', type: 'text', maxlen: 4, size: 6,
					suffix: ' <small>(范围: 256 - 2346; 默认: 2346)</small>', value: nvram['wl'+u+'_frag'] },
					{ title: '帧突发', name: 'wl'+u+'_frameburst', type: 'select', options: [['off','禁用 *'],['on','启用']],
					...
					{ title: '增强RX灵敏度', indent: 2, name: 'wlx_hperx' + (uidx > 0 ? uidx + '' : ''), type: 'select', options: [['0','禁用 *'],['1','启用']],
					value: nvram.wlx_hperx != '0', hidden: !hp || (uidx > 0) },
					{ title: '最大客户端', name: 'wl'+u+'_maxassoc', type: 'text', maxlen: 3, size: 5,
					...
					{ title: '报头', name: 'wl'+u+'_plcphdr', type: 'select', options: [['long','长 *'],['short','短']],
					value: nvram['wl'+u+'_plcphdr'] },
					{ title: '802.11n 报头', name: 'wl'+u+'_mimo_preamble', type: 'select', options: [['auto','自动'],['mm','混合模式 *'],['gf','绿色领域'],['gfbcm','GF-BRCM']],
					value: nvram['wl'+u+'_mimo_preamble'], hidden: !nphy },
					{ title: '重叠BSS共存', name: 'wl'+u+'_obss_coex', type: 'select', options: [['0','关闭 *'],['1','开启']],
					value: nvram['wl'+u+'_obss_coex'], hidden: !nphy },
					{ title: 'RTS阈值', name: 'wl'+u+'_rts', type: 'text', maxlen: 4, size: 6,
					...
					suffix: hp ?
					' <small>mW (放大前)</small>&nbsp;&nbsp;<small>(范围: 1 - 251; 默认: 10)</small>' :
					' <small>mW</small>&nbsp;&nbsp;<small>(范围: 0 - 400, 实际最大值取决于所选国家; 使用0作为硬件默认值)</small>',
					value: nvram['wl'+u+'_txpwr'] },
					{ title: '传输速率', name: 'wl'+u+'_rate', type: 'select',
					options: [['0','自动 *'],['1000000','1 Mbps'],['2000000','2 Mbps'],['5500000','5.5 Mbps'],['6000000','6 Mbps'],['9000000','9 Mbps'],['11000000','11 Mbps'],['12000000','12 Mbps'],['18000000','18 Mbps'],['24000000','24 Mbps'],['36000000','36 Mbps'],['48000000','48 Mbps'],['54000000','54 Mbps']],
					value: nvram['wl'+u+'_rate'] },
					{ title: '降低干扰', name: 'wl'+u+'_mitigation', type: 'select',
					options: [['0','无 *'],['1','非WLAN'],['2','WLAN标准'],['3','WLAN自动'],['4','WLAN自动降噪']],
					value: nvram['wl'+u+'_mitigation'] },
					{ title: 'WMM多媒体', name: 'wl'+u+'_wme', type: 'select', options: [['auto','自动'],['off','禁用'],['on','启用 *']], value: nvram['wl'+u+'_wme'] },
					{ title: '无ACK报文', name: 'wl'+u+'_wme_no_ack', indent: 2, type: 'select', options: [['off','禁用 *'],['on','启用']],
					value: nvram['wl'+u+'_wme_no_ack'] },
					{ title: 'APSD模式', name: 'wl'+u+'_wme_apsd', indent: 2, type: 'select', options: [['off','禁用 *'],['on','启用']],
					...
					htmlOut += ('<small>默认设置都以 <b style="font-size: 1.5em">*</b> 符合标识.</small></div></div>');
					}
					}
