	...
	<form id="_fom" method="post" action="tomato.cgi">
		...
		<div class="box" data-box="router-log">
			...
			<script type="text/javascript">
				...
				$('#router-log').forms([
					{ title: '内部日志', name: 'f_log_file', type: 'checkbox', value: nvram.log_file == 1 },
					{ title: '大小限制', name: 'log_file_size', type: 'text', maxlen: 5, size: 6, value: nvram.log_file_size || 50, suffix: ' <small>KB</small>' },
					...
					{ title: '主机或者IP地址 / 端口', indent: 2, multi: [
					...
					{ title: '记录DHCP客户端', indent: 2, name: 'f_log_dhcpc', type: 'checkbox', value: (nvram.log_events.indexOf('dhcpc') != -1) },
					{ title: '记录NTP', indent: 2, name: 'f_log_ntp', type: 'checkbox', value: (nvram.log_events.indexOf('ntp') != -1) },
					{ title: '记录定时事件', indent: 2, name: 'f_log_sched', type: 'checkbox', value: (nvram.log_events.indexOf('sched') != -1) },
					{ title: '记录连接日志' },
					{ title: '记录入站连接', indent: 2, name: 'log_in', type: 'select', options: [[0,'从不记录 (推荐)'],[1,'被防火墙阻止的'],[2,'被防火墙允许的'],[3,'两者都有']], value: nvram.log_in },
					{ title: '记录出站连接', indent: 2, name: 'log_out', type: 'select', options: [[0,'从不记录 (推荐)'],[1,'被防火墙阻止的'],[2,'被防火墙允许的'],[3,'两者都有']], value: nvram.log_out },
