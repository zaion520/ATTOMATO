	...
	<form id="_fom" method="post" action="tomato.cgi">
		...
		<div class="box">
			...
			<div class="content">
				...
				<script type='text/javascript'>
					$( '.blacklist_custom' ).forms( [ { title: '阻止的域名', name: 'adblock_blacklist_custom', type: 'textarea', value: nvram.adblock_blacklist_custom } ] );
				</script>

				<h4>自定义白名单</h4>
				<div class="whitelist"></div><hr>
				<script type="text/javascript">
					$( '.whitelist' ).forms( [ { title: '放行的域名', name: 'adblock_whitelist', type: 'textarea', value: nvram.adblock_whitelist } ] );
				</script>

				<h5>说明</h5>
				<div class='section'>
					<ul>
					<li><b>Adblock</b> - 自动更新将在每天凌晨1:00启动
					<li><b>调试模式</b> - dnsmasq的所有查询将被记录到syslog
					<li><b>黑名单 URL</b> - 正确的文件格式：0.0.0.0 domain.com或127.0.0.1 domain.com，每行一个.
					<li><b>自定义黑名单</b> - 可选 , 空格分隔：domain1.com domain2.com domain3.com
					<li><b>自定义白名单</b> - 可选 , 空格分隔：domain1.com domain2.com domain3.com
					</ul>
				</div>
