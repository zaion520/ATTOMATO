			...
			<div class="top-header">
				...
				<div class="pull-right links">
					<ul>
						...
						<li><a title="Bandwidth" href="#bwm-realtime.asp">带宽 <i class="icon-graphs"></i></a></li>
						<li><a title="IP Traffic" href="#bwm-ipt-realtime.asp">IP流量监控 <i class="icon-traffic"></i></a></li>
					...
					<div class="system-ui">
						...
						<div class="router-control">
							...
							<a href="#" onclick="logout();" class="btn">退出 <i class="icon-logout"></i></a>
						</div>
					</div>
				</div>
			</div>
