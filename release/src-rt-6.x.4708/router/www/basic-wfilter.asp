...
<content>
    ...
    <script type="text/javascript">
        ...
        smg.verifyFields = function(row, quiet) {
            ...
            return v_mac(f[0], quiet) && v_nodelim(f[1], quiet, '描述', 1);
        }
        ...
        <div class="box">
            ...
            <div class="content">
                <div class="radio c-radio">
                    <label>
                        <input type="radio" name="f_type" id="_f_disable" value="disabled">
                ...
                <div class="radio c-radio">
                    <label>
                        <input type="radio" name="f_type" id="_f_allow" value="allow">
                        <span class="icon-check">
                        </span>
                        仅允许以下客户端
                    </label>
                ...
                <div class="radio c-radio">
                    <label>
                        <input type="radio" name="f_type" id="_f_deny" value="deny">
                        <span class="icon-check">
                        </span>
                        阻止以下客户端
                    </label>
                ...
                <br />
                <br />
                <table id="sm-grid" class="line-table">
                </table>
            </div>
        </div>
