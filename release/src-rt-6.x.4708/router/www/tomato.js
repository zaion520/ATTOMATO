...
function navi() {
    ...
    var menu = {
        '状态': {
            "概述": "status-home.asp",
            "设备列表": "status-devices.asp",
            "浏览审计": "status-webmon.asp",
            "日志": "status-log.asp"
        },
        '基本设置': {
            ...
            /* IPV6-END */
            "路由标识": "basic-ident.asp",
            "系统时间": "basic-time.asp",
            "DDNS服务": "basic-ddns.asp",
            "DHCP服务": "basic-static.asp",
            "无线过滤": "basic-wfilter.asp"
        },
        '高级设置': {
            "访问限制": "advanced-restrict.asp",
            "网络服务": "advanced-ctnf.asp",
            "DHCP/DNS": "advanced-dhcpdns.asp",
            "防火墙": "advanced-firewall.asp",
            "广告拦截": "advanced-adblock.asp",
            /* NOCAT-BEGIN */
            "强制门户": "advanced-splashd.asp",
            /* NOCAT-END */
            "MAC地址": "advanced-mac.asp",
            "其他": "advanced-misc.asp",
            ...
            "局域网访问": "advanced-access.asp",
            "虚拟无线": "advanced-wlanvifs.asp"
        },
        '端口转发': {
            "IPv4设置": "forward-basic.asp",
            /* IPV6-BEGIN */
            "IPv6设置": "forward-basic-ipv6.asp",
            /* IPV6-END */
            "DMZ主机": "forward-dmz.asp",
            "端口触发": "forward-triggered.asp",
            "UPnP服务": "forward-upnp.asp"
        },
        'Qos服务': {
            "基本设置": "qos-settings.asp",
            "分类规则": "qos-classify.asp",
            "查看图表": "qos-graphs.asp",
            "查看详细": "qos-detailed.asp",
            "传输速率": "qos-ctrate.asp",
            "带宽限制": "qos-qoslimit.asp"
        },
        /* USB-BEGIN */
        ...
        'USB和NAS': {
            ...
            /* BT-BEGIN */
            ,
            "BitTorrent客户端": "nas-bittorrent.asp"
            /* BT-END */
        },

        /* NGINX-BEGIN */
        '网页服务': {
            "HTTP服务器": "web-nginx.asp",
            "MySQL服务器": "web-mysql.asp"
        },
        /* NGINX-END */
        /* USB-END */
        /* VPN-BEGIN */
        ...
        /* VPN-END */
        '系统管理': {
            "管理设置": "admin-access.asp",
            "番茄统计": "admin-tomatoanon.asp",
            "带宽监控": "admin-bwm.asp",
            "IP流量监控": "admin-iptraffic.asp",
            "按钮/LED": "admin-buttons.asp",
            /* CIFS-BEGIN */
            "CIFS客户端": "admin-cifs.asp",
            /* CIFS-END */
            /* SDHC-BEGIN */
            'SDHC/MMC存储卡': 'admin-sdhc.asp',
            /* SDHC-END */
            "配置": "admin-config.asp",
            "调试": "admin-debug.asp",
            /* JFFS2-BEGIN */
            ...
            /* JFFS2-END */
            /* NFS-BEGIN */
            "NFS服务器": "admin-nfs.asp",
            /* NFS-END */
            "记录": "admin-log.asp",
            "计划任务": "admin-sched.asp",
            "脚本": "admin-scripts.asp",
            /* SNMP-BEGIN */
            "SNMP": "admin-snmp.asp",
            /* SNMP-END */
    ...
    // Add custom menu
    try {
        $.extend(true, menu, JSON.parse(nvram.at_nav));
    } catch(e) {
    ...
    function(key, linksobj) {
        ...
        function(name, link) {
            ...
            if (/\//i.test(link) === false) {
                link = '#' + link;
            } // Add location hash for non-root links
            if (/http(s)?:\/\//i.test(link)) {
                link = link + '" target="_blank';
            } // If link includes http or https, create new tab/window
