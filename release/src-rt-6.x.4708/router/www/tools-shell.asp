...
<li><a class="ajaxload" href="tools-wol.asp"><i class="icon-wake"></i> WOL网络唤醒</a></li>
	...
	<div class="box">
		<div class="heading">系统Shell</div>
		<div class="content">
			<div id="command-form"></div><hr>

			<div style="visibility:hidden;" id="wait">请稍后... <span class="spinner"></span></div>
			<pre id="result"></pre>

			<script type="text/javascript">
				$('#command-form').forms([
{ title: '命令', help:'使用命令“nvram export -set” 或“nvram export -set |” grep qos“ 以剪切和粘贴配置',
name: 'f_cmd', type: 'textarea', wrap: 'off', value: '', style: 'width: 100%; height: 80px;' }
	...
	<div id="refresh"></div><button type="button" value="Execute" onclick="execute()" id="execb" class="btn">执行 <i class="icon-cmd"></i></button>
