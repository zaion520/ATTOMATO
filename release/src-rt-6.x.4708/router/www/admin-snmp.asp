		...
		<div class="box">
			...
			<script type="text/javascript">
				$('#config-section').forms([
					...
					{ title: '允许远程访问', indent: 2, name: 'f_snmp_remote', type: 'checkbox', value: nvram.snmp_remote == '1' },
					...
					{ title: 'RO社区', indent: 2, name: 'snmp_ro', type: 'text', maxlen: 40, size: 64, value: nvram.snmp_ro }
					]);
			</script>
		</div>
	</form>
