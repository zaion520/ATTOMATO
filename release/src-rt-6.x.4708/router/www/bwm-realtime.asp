...
<content>
	...
	<div class="box">
		<div class="heading">实时带宽监控 &nbsp;  <div class="spinner" id="refresh-spinner" onclick="javascript:debugTime=1"></div></div>
		<div class="content">
			<div id="rstats">
				...
				<div id="bwm-controls">
					<small>(<span class="updatetime"></span> 分钟 绘图窗口, <span class="interval"></span> 秒间隔)</small> -
					<b>平均</b>:
				...
				<table id="txt" class="data-table bwm-info">
					<tr>
						<td><b style="border-bottom:blue 1px solid" id="rx-name">下行</b> <i class="icon-arrow-down"></i></td>
					...
					<tr>
						<td><b style="border-bottom:blue 1px solid" id="tx-name">上行</b> <i class="icon-arrow-up"></i></td>
			...
			<div id="warnwd" class="alert alert-warning" style="display:none">警告：10秒会话超时，重新启动...&nbsp;</div>
		</div>
	</div>
