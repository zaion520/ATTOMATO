<!--Tomato GUI Copyright(C)2006-2010 Jonathan Zarate http:IP Traffic enhancements
Copyright(C)2011 Augusto Bott http:For use with Tomato Firmware only.No
...
<content>
    <style type="text/css">
        #daily-grid.co3,#daily-grid.co4,#daily-grid.co5{text-align:right}
    </style>
    ...
    <ul class="nav-tabs">
        ...
        <li>
            <a class="ajaxload" href="bwm-ipt-monthly.asp">
                <i class="icon-month">
                </i>
                每月
            </a>
    ...
    <div id="cstats" class="box">
        ...
        <div class="content">
            <table id="daily-grid" class="line-table td-large">
            </table>
            <br/>
            <h4>
    ...
    <script type="text/javascript">
        ...
        c.push({
            ...
            name: 'f_dafm',
            type: 'select',
            options: [['0', 'yyyy-mm-dd'], ['1', 'mm-dd-yyyy'], ['2', 'mmm dd, yyyy'], ['3', 'dd.mm.yyyy']]
        });
        c.push({
            title: '单位',
            name: 'f_scale',
