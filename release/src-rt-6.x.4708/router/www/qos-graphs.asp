...
<content>
	...
	<script type="text/javascript">
		if (nvram.qos_enable != '1') {
			$('.container .ajaxwrap').prepend('<div class="alert alert-info"><b>QoS已禁用.</b>&nbsp; <a class="ajaxload" href="#qos-settings.asp">启用 &raquo;</a> <a class="close"><i class="icon-cancel"></i></a></div>');
		}
	</script>

	<div class="box graphs">
		<div class="heading">连接分布</div>
		<div class="content">
			<div id="svg-0" class="embedGraph"></div>

			<table id="firstTable">
				<tr><td>&nbsp;</td><td class="total">总计</td><td id="ccnt-total" class="total count"></td><td class="total pct">100%</td></tr>
			</table>
	...
	<div class="fluid-grid x2">
		<div class="box graphs">
			...
			<div class="content">
				...
				<table id="secondTable">
					...
					<tr><td>&nbsp;</td><td class="total">总计</a></td><td id="bocnt-total" class="total count"></td><td id="bocntx-total" class="total count"></td><td id="rateout" class="total pct"></td></tr>
				</table>
		...
		<div class="box graphs">
			<div class="heading">带宽分配（入站）</div>
			<div class="content">
				<div id="svg-2" class="embedGraph"></div>

				<table id="thirdTable">
					<tr><td class="color" style="height:1em; margin-right: 5px;"></td><td class="title">&nbsp;</td><td class="thead count">kbit/s</td><td class="thead count">KB/s</td><td class="thead pct">&nbsp;</td></tr>
					<tr><td>&nbsp;</td><td class="total">总计</a></td><td id="bicnt-total" class="total count"></td><td id="bicntx-total" class="total count"></td><td id="ratein" class="total pct"></td></tr>
				</table>
	...
	<button name="mybtn" value="Zoom Graphs" type="button" onclick="showGraph()" class="btn">缩放图 <i class="icon-search"></i></button>
