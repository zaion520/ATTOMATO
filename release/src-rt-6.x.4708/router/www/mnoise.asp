<html lang="zh-CN">
	...
	<body onload="init()" onclick="go()">
		...
		<div id="loader">
			<div style="font-size: 14px; font-weight: bold; padding-bottom: 5px;"><div class="spinner"></div>&nbsp; 测量无线电噪声...</div>
			无线访问已暂时停用 <span id="time">15 秒</span>.
		</div>
