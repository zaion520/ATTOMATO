...
<content>
	...
	<script type="text/javascript">
		...
		tg.setup = function() {
			this.init('ttr-grid');
			this.headerSet(['跳跃', '地址', '最小 (ms)', '最大 (ms)', '平均 (ms)', '+/- (ms)']);
		}
...
suffix: ' <button type="submit" value="Trace" onclick="trace()" id="traceb" class="btn">追踪 <i class="icon-gauge"></i></button>' },
{ title: '最大跳数', name: 'f_hops', type: 'text', maxlen: 2, size: 4, value: '20' },
