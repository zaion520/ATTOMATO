...
<content>
	...
	<script type="text/javascript">
		...
		tabs = [['as-init', '<i class="icon-system"></i> 初始化'],['as-shut', '<i class="icon-power"></i> 关机'],['as-fire','<i class="icon-shield"></i> 防火墙'],['as-wanup', '<i class="icon-globe"></i> 当WAN联机']];
