...
<content>
	...
	<ul class="nav-tabs">
		...
		<li><a class="ajaxload" href="bwm-ipt-daily.asp"><i class="icon-clock"></i> 每日</a></li>
		<li><a class="ajaxload" href="bwm-ipt-monthly.asp"><i class="icon-month"></i> 每月</a></li>
	</ul>

	<div id="cstats" class="box">
		<div class="heading">实时IP流量监控 &nbsp; <div class="spinner" id="refresh-spinner" onclick="javascript:debugTime=1"></div></div>
		<div class="content">
			...
			<div id="bwm-controls">
				<small>(<span class="updatetime"></span> 分钟视图, <span class="interval"></span> 秒间隔)</small> -
				<b>平均</b>:
				...
				<b>数量</b>:
				<a href="javascript:switchScale(0)" id="scale0">全部</a> 或
				<a href="javascript:switchScale(1)" id="scale1">单个</a> |
				<b>显示</b>:
				<a href="javascript:switchDraw(0)" id="draw0">填充</a> 或
				<a href="javascript:switchDraw(1)" id="draw1">实线</a> |
				<b>颜色</b>: <a href="javascript:switchColor()" id="drawcolor">-</a> |
				<small><a href="javascript:switchColor(1)" id="drawrev">[反转]</a></small>
				| <a class="ajaxload" href="admin-iptraffic.asp"><b>配置</b></a>
			</div>

			<table id="txt" class="data-table bwm-info">
				<tr>
					<td><b style="border-bottom:blue 2px solid" id="rx-name">下行</b> <i class="icon-arrow-down"></i></td>
				...
				<tr>
					<td><b style="border-bottom:blue 2px solid" id="tx-name">上行</b> <i class="icon-arrow-up"></i></td>
			...
			<script type="text/javascript">
				$('#options').forms([
					{ title: '当前的IP', name: 'f_ipt_addr_shown', type: 'select', options: [[0,'选择']], suffix: ' &nbsp; <small>(从此列表中单击/选择设备以将其隐藏)</small>' },
{ title: '隐藏的IP', name: 'f_ipt_addr_hidden', type: 'select', options: [[0,'选择']], suffix: ' &nbsp; <small>(单击/选择以再次显示)</small>' }
				]);
			</script>
