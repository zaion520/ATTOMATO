...
<content>
    ...
    <script type="text/javascript">
        ...
        function redraw() {
            ...
            grid += '<tr><td style="width:25%;"><b>日期</b></td><td style="width:25%;"><b>下行</b></td><td style="width:25%;"><b>上行</b></th><td style="width:25%;"><b>总计</b></td></tr>';

            for (i = 0; i < daily_history.length; ++i) {
                h = daily_history[i];
                ymd = getYMD(h[0]);
                grid += makeRow(((rows & 1) ? 'odd': 'even'), ymdText(ymd[0], ymd[1], ymd[2]), rescale(h[1]), rescale(h[2]), rescale(h[1] + h[2])); ++rows;
        ...
        function init() {
            ...
            if (nvram.rstats_enable != '1') {
                $('#rstats').before('<div class="alert alert-warning">带宽监控已禁用.</b> <a href="/#admin-bwm.asp">启用 &raquo;</a></div>');
                return;
            }
            checkRstats();
    ...
    <ul class="nav-tabs">
        ...
        <li>
            <a class="ajaxload" href="bwm-24.asp">
                <i class="icon-graphs">
                </i>
                最近24小时
            </a>
    ...
    <div id="rstats" class="box">
        ...
        <div class="content">
            <div id="bwm-daily-grid" class="span7" style="float: left;">
            </div>
                    ...
                    <thead>
                        <tr>
                            <th colspan=2 style="text-align:center">
                                最近30天
                                <br>
                                <span style="font-weight:normal" id="last-dates">
                                </span>
                            </th>
                        </tr>
                    </thead>
    ...
    <a class="btn btn-primary" href="javascript:genData();">
        数据
        <i class="icon-drive">
        </i>
    </a>
    <a class="btn btn-danger ajaxload" href="admin-bwm.asp">
        配置
        <i class="icon-tools">
        </i>
    </a>
