...
<content>
    <script type="text/javascript">
        ...
        function verifyFields(focused, quiet) {
            ...
            // IP address
            a = ['_ipv6_tun_v4end'];
            for (i = a.length - 1; i >= 0; --i) if ((vis[a[i]]) && (!v_ip(a[i], quiet || !ok))) ok = 0;
            ...
            // IPv6 address
            a = ['_ipv6_tun_addr'];
            for (i = a.length - 1; i >= 0; --i) if ((vis[a[i]]) && (!v_ipv6_addr(a[i], quiet || !ok))) ok = 0;
            ...
            for (i = a.length - 1; i >= 0; --i) if ((vis[a[i]] == 1) && (E(a[i]).value.length > 0) && (!v_ipv6_addr(a[i], quiet || !ok))) ok = 0;
        ...
        function save() {
            ...
            if (fom.f_ipv6_accept_ra_wan.checked && !fom.f_ipv6_accept_ra_wan.disabled) fom.ipv6_accept_ra.value |= 1;
            if (fom.f_ipv6_accept_ra_lan.checked && !fom.f_ipv6_accept_ra_lan.disabled) fom.ipv6_accept_ra.value |= 2;
            ...
            case 'native-pd':
                fom.ipv6_prefix.value = '';
                fom.ipv6_rtr_addr.value = '';
                if (fom.f_lan1_ipv6.checked) fom.ipv6_vlan.value |= 1;
                if (fom.f_lan2_ipv6.checked) fom.ipv6_vlan.value |= 2;
                if (fom.f_lan3_ipv6.checked) fom.ipv6_vlan.value |= 4;
                break;
            default:
                fom.ipv6_rtr_addr.disabled = fom.f_ipv6_rtr_addr_auto.disabled;
                if (fom.f_ipv6_rtr_addr_auto.value == 1) fom.ipv6_rtr_addr.value = fom.f_ipv6_rtr_addr.value;
                else fom.ipv6_rtr_addr.value = '';
                break;
            }
            ...
            <div class="content">
                ...
                <script type="text/javascript">
                    ...
                    $('#section-ipv6 .formfields').forms([{
                        ...
                        name: 'ipv6_service',
                        type: 'select',
                        options: [['', '禁用'], ['native', 'Native IPv6 from ISP'], ['native-pd', 'DHCPv6 with Prefix Delegation'], ['6to4', '6to4 Anycast Relay'], ['sit', '6in4 Static Tunnel'], ['6rd', '6RD Relay'], ['6rd-pd', '6RD from DHCPv4 (Option 212)'], ['other', 'Other (手动配置)']],
                    ...
                    null, {
                        ...
                        maxlen: 46,
                        size: 48,
                        value: nvram.ipv6_prefix
                    },
                    {
                        title: '6RD路由前缀',
                        name: 'ipv6_6rd_prefix',
                        type: 'text',
                        maxlen: 46,
                        size: 48,
                        value: nvram.ipv6_6rd_prefix
                    },
                    {
                        title: '6RD前缀长度',
                        name: 'ipv6_6rd_prefix_length',
                        type: 'text',
                        maxlen: 3,
                        size: 5,
                        value: nvram.ipv6_6rd_prefix_length,
                        suffix: ' <small>(通常 32)</small>'
                    },
                    {
                        title: '前缀长度',
                        name: 'f_ipv6_prefix_length',
                        type: 'text',
                        maxlen: 3,
                        size: 5,
                        value: nvram.ipv6_prefix_length
                    },
                    {
                        title: '仅请求PD',
                        name: 'f_ipv6_pdonly',
                        type: 'checkbox',
                        value: (nvram.ipv6_pdonly != '0')
                    },
                    {
                        title: '路由器IPv6地址',
                        multi: [{
                            name: 'f_ipv6_rtr_addr_auto',
                            type: 'select',
                            options: [['0', '默认'], ['1', '自定义']],
                            value: (nvram.ipv6_rtr_addr == '' ? '0': '1')
                        },
                        {
                            name: 'f_ipv6_rtr_addr',
                            type: 'text',
                            maxlen: 46,
                            size: 48,
                            value: nvram.ipv6_rtr_addr
                        }]
                    },
                    {
                        title: '静态DNS',
                    ...
                    },
                    {
                        ...
                        multi: [{
                            suffix: '&nbsp; WAN &nbsp;&nbsp;&nbsp;',
                            name: 'f_ipv6_accept_ra_wan',
                            type: 'checkbox',
                            value: (nvram.ipv6_accept_ra & 1)
                        },
                        {
                            suffix: '&nbsp; LAN &nbsp;',
                            name: 'f_ipv6_accept_ra_lan',
                            type: 'checkbox',
                            value: (nvram.ipv6_accept_ra & 2)
                        }]
                    },
                    null, {
                        title: '隧道远程端点 (IPv4 地址)',
                        name: 'ipv6_tun_v4end',
                        type: 'text',
                        maxlen: 15,
                        size: 17,
                        value: nvram.ipv6_tun_v4end
                    },
                    {
                        title: '6RD (IPv4 地址)',
                        name: 'ipv6_6rd_borderrelay',
                        type: 'text',
                        maxlen: 15,
                        size: 17,
                        value: nvram.ipv6_6rd_borderrelay
                    },
                    {
                        title: '6RD IPv4掩码长度',
                        name: 'ipv6_6rd_ipv4masklen',
                        type: 'text',
                        maxlen: 3,
                        size: 5,
                        value: nvram.ipv6_6rd_ipv4masklen,
                        suffix: ' <small>(通常 0)</small>'
                    },
                    {
                        title: '中继广播地址',
                        name: 'ipv6_relay',
                        ...
                        maxlen: 3,
                        size: 5,
                        prefix: '192.88.99.&nbsp&nbsp',
                        value: nvram.ipv6_relay
                    },
                    {
                        title: '隧道客户端IPv6地址',
                        multi: [{
                            ...
                            maxlen: 46,
                            size: 48,
                            value: nvram.ipv6_tun_addr,
                            suffix: ' / '
                        },
                        {
                            name: 'ipv6_tun_addrlen',
                            type: 'text',
                            maxlen: 3,
                            size: 5,
                            value: nvram.ipv6_tun_addrlen
                        }]
                    },
                    {
                        title: '隧道MTU',
                        ...
                        maxlen: 4,
                        size: 8,
                        value: nvram.ipv6_tun_mtu,
                        suffix: ' <small>(默认：0)</small>'
                    },
                    {
                        title: '隧道TTL',
                        name: 'ipv6_tun_ttl',
                        ...
                        maxlen: 3,
                        size: 8,
                        value: nvram.ipv6_tun_ttl
                    },
                    null, {
                        title: '请求/64子网',
                        name: 'f_lan1_ipv6',
                        type: 'checkbox',
                        value: (nvram.ipv6_vlan & 1),
                        suffix: '&nbsp; LAN1 &nbsp;&nbsp;&nbsp;'
                    },
                    {
                        title: '',
