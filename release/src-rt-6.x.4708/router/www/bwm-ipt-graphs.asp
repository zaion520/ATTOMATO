<!-- Tomato GUI Copyright (C) 2006-2007 Jonathan Zarate http://www.polarcloud.com/tomato/
For use with Tomato Firmware only. No part of this file may be used without
permission. LAN Access admin module by Augusto Bott -->
<title>
    IP 流量监控: 查看图表
</title>
<content>
    <style type="text/css">
        table { margin: 8px 0 0; } .color { width: 12px; height: 25px; } .title
        { padding: 0 5px; } .count { text-align: right; padding-bottom: 2px; }
        .pct { width:55px; padding: 0 0 2px 10px; text-align: right; } .thead {
        font-size: 90%; font-weight: 500; } .total { border-top: 1px dashed #bbb;
    ...
    <script type="text/javascript">
        ...
        var svgReady = 0;
        var abc = ['', '', '', '', '', '', '', '', '', '', ''];
        var colors = ['c6e2ff', 'b0c4de', '9ACD32', '3cb371', '6495ed', '8FBC8F', 'a0522d', 'deb887', 'F08080', 'ffa500', 'ffd700'];
        var lock = 0;
        ...
        function init() {
            ...
            // Data
            for (i = 0; i < 11; ++i) {
                $('#firstTable').prepend('<tr>' + '<td class="color" style="background:#' + colors[i] + '" onclick="mClick(' + i + ')">&nbsp;</td>' + '<td class="title" style="padding-left: 8px;"><a class="ajaxload" href="/#bwm-ipt-details.asp?ipt_filterip=' + abc[i] + '">' + abc[i] + '</a></td>' + '<td id="ccnt' + i + '" class="count"></td>' + '<td id="cpct' + i + '" class="pct"></td></tr>');
            }

            for (i = 0; i < 11; ++i) {
                $('#secondTable').prepend('<tr>' + '<td class="color" style="background:#' + colors[i] + '" onclick="mClick(' + i + ')">&nbsp;</td>' + '<td class="title" style="padding-left: 8px;"><a class="ajaxload" href="/#bwm-ipt-details.asp?ipt_filterip=' + abc[i] + '">' + abc[i] + '</a></td>' + '<td id="bcnt' + i + '" class="count"></td>' + '<td id="bcntx' + i + '" class="count"></td>' + '<td id="bpct' + i + '" class="pct"></td></tr>');
            }

            for (i = 0; i < 11; ++i) {
                $('#thirdTable').prepend('<tr>' + '<td class="color" style="background:#' + colors[i] + '" onclick="mClick(' + i + ')">&nbsp;</td>' + '<td class="title" style="padding-left: 8px;"><a class="ajaxload" href="/#bwm-ipt-details.asp?ipt_filterip=' + abc[i] + '">' + abc[i] + '</a></td>' + '<td id="obcnt' + i + '" class="count"></td>' + '<td id="obcntx' + i + '" class="count"></td>' + '<td id="obpct' + i + '" class="pct"></td></tr>');
            }
    ...
    <div class="fluid-grid x3">
        <div class="box graphs">
            ...
            <div class="content">
                ...
                <table id="firstTable">
                    <tr>
                        <td class="color" style="height:1em">
                        </td>
                        <td class="title" style="width:45px">
                            &nbsp;
                        </td>
                        <td class="thead count">
                            kbit/s
                        </td>
                        <td class="pct">
                            &nbsp;
                    ...
                    <tr>
                        ...
                        <td id="ccnt-total" class="total count">
                        </td>
                        <td class="total pct">
                            100%
                        </td>
            ...
            <div class="content">
                ...
                <table id="secondTable">
                    ...
                    <tr>
                        ...
                        <td id="bcnt-total" class="total count">
                        </td>
                        <td id="bcntx-total" class="total count">
                        </td>
                        <td class="total pct">
                            100%
                        </td>
            ...
            <div class="content">
                ...
                <table id="thirdTable">
                    ...
                    <tr>
                        ...
                        <td id="obcnt-total" class="total count">
                        </td>
                        <td id="obcntx-total" class="total count">
                        </td>
                        <td class="total pct">
                            100%
                        </td>
    ...
    <script type="text/javascript">
        $('#refresh').html(genStdRefresh(1, 1, 'ref.toggle()'));
        init();
    </script>
</content>