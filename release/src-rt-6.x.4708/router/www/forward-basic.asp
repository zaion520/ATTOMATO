	...
	<form id="_fom" method="post" action="javascript:{}">
		...
		<div class="box">
			...
			<div class="content">
				...
				<h4>说明</h4>
<ul>
<li><b>源地址</b> <i>(可选)</i> - 只有从这个地址. 例如: "1.2.3.4", "1.2.3.4 - 2.3.4.5", "1.2.3.0/24", "me.example.com".
<li><b>外部端口</b> - 要转发的端口，如从广域网所看到的. 例如: "2345", "200,300", "200-300,400".
<li><b>内部端口</b> <i>(可选)</i> - 局域网内的目标端口。如果空白，目标端口
是相同的 <i>外部端口</i>. 当转发到一个不同的内部时，每个条目只支持一个端口
.
<li><b>内部地址</b> - 局域网内的目的地址.
</ul>
			</div>
		</div>
