	...
	<script type="text/javascript">
		...
		la.setup = function() {
			this.init('la-grid', 'sort', 50, [
				...
				{ type: 'text', maxlen: 32, class: 'input-medium' },
				{ type: 'text', maxlen: 32, class: 'input-medium' }]);
			this.headerSet(['状态', '源', '源IP地址', '目标', '目标IP地址', '描述']);
	...
	<div class="box">
		...
		<div class="content">
			...
			<div class="section" id="sesdiv_notes" style="display:none">
				<ul>
					<li><b>源</b> - 本地LAN口</li>
					<li><b>源IP地址</b> <i>(选项)</i> - 本地IP地址。 例如: "1.2.3.4", "1.2.3.4 - 2.3.4.5", "1.2.3.0/24".</li>
					<li><b>目标</b> - 目标的LAN口.</li>
					<li><b>目标IP地址</b> <i>(选项)</i> - 目标的局域网IP地址.</li>
				</ul>
			</div>
		</div>
	</div>
