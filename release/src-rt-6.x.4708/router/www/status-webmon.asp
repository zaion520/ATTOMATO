...
<content><style type="text/css">
	...
	<script type="text/javascript">
		...
		function clearLog(clear)
		{
			...
			xob.onCompleted = function(text, xml) {
				xob = null;
				E('clear' + clear).innerHTML = '<a class="btn btn-primary btn-small" href="javascript:clearLog(' + clear + ')">清除日志 <i class="icon-cancel"></i></a>';
			...
			E('clear' + clear).innerHTML = '请稍后... <div class="spinner"></div>';
		}
	...
	<div class="row" id="webmon" style="display:none">
		...
		<div id="webmon-controls">
			<div id="webmon-mc">
				...
				<a href="javascript:switchMaxCount(0);" id="mc0">全部</a>&nbsp;
				<small>总计数量</small>
			</div>
			&raquo; <a class="ajaxload" href="admin-log.asp">浏览审计设置</a>
			<br><br>
		</div>
	</div>
	...
	<div id="wm-disabled" class="alert alert-info icon">
		<h5>浏览审计已禁用</h5>
		请先 <a class="ajaxload" href="/#admin-log.asp">启用</a> 浏览审计才能查看更多信息。
	</div>
