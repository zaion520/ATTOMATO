...
options: [['br0','LAN (LAN0)'],['br1','LAN1  (LAN1)'],['br2','LAN2 (LAN2)'],['br3','LAN3 (LAN3)']], value: nvram.dmz_ifname },
					/* VLAN-END */
					{ title: '外部IP限制', indent: 2, name: 'f_dmz_sip', type: 'text', maxlen: 512, size: 64,
value: nvram.dmz_sip, suffix: '<small>(可选; 例如: "1.1.1.1", "1.1.1.0/24", "1.1.1.1 - 2.2.2.2" or "me.example.com")</small>' }
					]);
			</script>
		</div>
