...
<content>
    <style>
        table.line-table tr td.co1 { width:62%; } table.line-table tr td.co2 {
        width:13%; } table.line-table tr td.co3 { width:21%; } table.line-table
        tr td.co4 { width:4%; } /* Style the first column editorRow */ .erow div.xa
        { width: 30%; padding: 0px; } /* Style second column editorRow */ .erow
        div.xb { width: 65%; padding-left:10px;} /* Style third editorRow column
        */ .erow div.xc { padding-left:10px; } /* Override default styling for
        editorRow 2 */ .erow.y2 div.xb { width: 22%; } /* Column2 */ .erow.y2 div.xc
        { width: 43%; padding-left: 2px; } /* Column3 */ /* Override default styling
        for editorRow 5: Column1 (KB Transferred), Column2 (KB From), Column3 (the
        dash), Column4 (KB To) */ /* Text only fields (Column 1 & Column 3) */
        .erow.y5 div.xa, .erow.y5 div.xc { padding-top: 7px; } .erow.y5 div.xa
        { padding-left: 7px; } /* Column1 (KB Transferred) */ .erow.y5 div.xb {
        width: 25%; padding-right: 0px; } /* Column2 (KB From) */ .erow.y5 div.xc
        { width: 3%; padding-left: 0px; padding-right:0px; text-align:center }
        /* Column3 (the dash) */ .erow.y5 div.xd { width: 25%; padding-left: 0px;
        } /* Column4 (KB To) */
    </style>
    ...
    <script type="text/javascript">
        ...
        var ipp2p = [[0, 'IPP2P (禁用)'], [0xFFF, 'All IPP2P filters'], [1, 'AppleJuice'], [2, 'Ares'], [4, 'BitTorrent'], [8, 'Direct Connect'], [16, 'eDonkey'], [32, 'Gnutella'], [64, 'Kazaa'], [128, 'Mute'], [256, 'SoulSeek'], [512, 'Waste'], [1024, 'WinMX'], [2048, 'XDCC']];

        var dscp = [['', 'DSCP (所有)'], ['0x00', 'BE'], ['0x08', 'CS1'], ['0x10', 'CS2'], ['0x18', 'CS3'], ['0x20', 'CS4'], ['0x28', 'CS5'], ['0x30', 'CS6'], ['0x38', 'CS7'], ['0x0a', 'AF11'], ['0x0c', 'AF12'], ['0x0e', 'AF13'], ['0x12', 'AF21'], ['0x14', 'AF22'], ['0x16', 'AF23'], ['0x1a', 'AF31'], ['0x1c', 'AF32'], ['0x1e', 'AF33'], ['0x22', 'AF41'], ['0x24', 'AF42'], ['0x26', 'AF43'], ['0x2e', 'EF'], ['*', 'DSCP value']];
        for (i = 1; i < dscp.length - 1; ++i) dscp[i][1] = 'DSCP类 ' + dscp[i][1];

        // <% layer7(); %>
        layer7.sort();
        for (i = 0; i < layer7.length; ++i) layer7[i] = [layer7[i], layer7[i]];
        ...
        qosg.dataToView = function(data) {
            ...
            if (data[5] != 0) {
                for (i = 0; i < ipp2p.length; ++i) if (ipp2p[i][0] == data[5]) {
        ...
        qosg.setup = function() {
            var i, a, b;
            a = [[ - 2, '任何协议'], [ - 1, 'TCP/UDP'], [6, 'TCP'], [17, 'UDP']];
            for (i = 0; i < 256; ++i) {
            ...
            this.init('qg', 'move', 80, [{
                multi: [{
                    type: 'select',
                    options: [[0, '任何地址'], [1, '目标IP'], [2, '源IP'], [3, '源MAC地址']],
                    prefix: '<div class="erow y1"><div class="xa">',
                    suffix: '</div>'
                },
                {
                    type: 'text',
                ...
                {
                    type: 'select',
                    prefix: '<div class="erow y2"><div class="xa">',
                    suffix: '</div>',
                    options: a
                },
                {
                ...
                {
                    type: 'select',
                    prefix: '<div class="erow y3"><div class="xa">',
                    suffix: '</div>',
                    options: ipp2p
                },
                {
                ...
                {
                    type: 'select',
                    prefix: '<div class="erow y4"><div class="xa">',
                    suffix: '</div>',
                    options: dscp
                },
                {
                ...
                {
                    type: 'text',
                    prefix: '<div class="erow y5"><div class="xa">KB 传输字节</div><div class="xb">',
                    suffix: '</div>'
                },
                {
                    type: 'text',
                    prefix: '<div class="xc">-</div><div class="xd">',
                    suffix: '</div></div>'
                }]
            },
            {
