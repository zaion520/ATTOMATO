...
var class_udp = [['0','无限制']];
		...
		qosg.setup = function() {
			...
			this.headerSet(['IP | IP范围 | MAC地址', '下载速率(kbps/s)', '下载上限(kbps/s)', '上传速率(kbps/s)', '上传上限(kbps/s)', '优先级', 'TCP限制', 'UDP限制']);
		...
		qosg.verifyFields = function(row, quiet)
		{
			...
			*/
			if(v_macip(f[0], quiet, 0, nvram.lan_ipaddr, nvram.lan_netmask)) {
				if(this.existIP(f[0].value)) {
					ferror.set(f[0], '重复的IP或MAC地址', quiet);
					ok = 0;
				}
			}

			if( this.checkRate(f[1].value)) {
				ferror.set(f[1], '下载速率必须介于1和99999之间', quiet);
				ok = 0;
			}

			if( this.checkRate(f[2].value)) {
				ferror.set(f[2], '下载上限必须介于1和99999之间', quiet);
				ok = 0;
			}
			...
			if( this.checkRate(f[3].value)) {
				ferror.set(f[3], '上传速率必须介于1和99999之间', quiet);
				ok = 0;
			}

			if( this.checkRate(f[4].value)) {
				ferror.set(f[4], '上传上限必须介于1和99999之间', quiet);
				ok = 0;
			}
	...
	<form id="_fom" method="post" action="tomato.cgi">
		...
		<div class="box" data-box="qos-lan-limit">
			<div class="heading">LAN带宽限制 (br0)</div>
			<div class="content">
				<div class="br0-set"></div><hr>
				<script type="text/javascript">
					$('.br0-set').forms([
{ title: '启用限速', name: 'f_new_qoslimit_enable', type: 'checkbox', value: nvram.new_qoslimit_enable != '0' },
{ title: '最大下载带宽<br> <small>（与QoS中使用的相同）</small>', indent: 2, name: 'wan_qos_ibw', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.wan_qos_ibw },
{ title: '最大上传带宽<br> <small>（与QoS中使用的相同）</small>', indent: 2, name: 'wan_qos_obw', type: 'text', maxlen: 6, size: 8, suffix: ' <small>kbit/s</small>', value: nvram.wan_qos_obw }
]);
				</script>
...
<li><b>MAC地址</b> 例如: 00:2E:3C:6A:22:D8
		...
		<div class="box" id="qoslimitbr0" data-box="qos-br0-limit">
			<div class="heading">LAN中未列出的MAC / IP的默认类别 (br0)</div>
			<div class="content">
...
{ title: 'TCP限制', indent: 2, name: 'qosl_tcp', type: 'select', options:
							[['0', '无限制'],
								['1', '1'],
								['2', '2'],
								['5', '5'],
						...
						{ title: 'UDP限制', indent: 2, name: 'qosl_udp', type: 'select', options:
[['0', '无限制'],
								['1', '1/s'],
								['2', '2/s'],
								['5', '5/s'],
				...
				<ul>
					<li>默认分类 - 未收录的IP/MAC 地址将被归为默认分类.</li>
<li>所有的未收录主机将共享br0的宽带.</li>
				</ul>
			</div>
		</div>

		<div class="box" id="qoslimitbr1" data-box="qos-limit-br1">
			<div class="heading">LAN1的默认类别 (br1)</div>
			<div class="content">
...
[['0','最高'],['1','高'],['2','正常'],['3','低'],['4','最低']], value: nvram.limit_br1_prio }
				...
				<ul>
					<li>br1中的所有主机将共享带宽。</li>
				</ul>
			</div>
		</div>

		<div class="box" id="qoslimitbr2" data-box="qos-limit-br2">
			<div class="heading">LAN2的默认类别 (br2)</div>
			<div class="content">
...
[['0','最高'],['1','高'],['2','正常'],['3','低'],['4','最低']], value: nvram.limit_br2_prio }
				...
				<ul>
					<li>br2中的所有主机将共享带宽。</li>
				</ul>
			</div>
		</div>

		<div class="box" id="qoslimitbr3" data-box="qos-limit-br3">
			<div class="heading">LAN3的默认类别 (br3)</div>
			<div class="content">
