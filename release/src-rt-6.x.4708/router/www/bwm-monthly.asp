...
<content>
	...
	<script type="text/javascript">
		...
		function redraw()
		{
			...
			grid += '<tr><td><b>日期</b></td><td><b>下行</b></td><td><b>上行</b></th><td><b>总计</b></td></tr>';
...
<li><a class="active"><i class="icon-month"></i> 每月</a></li>
	...
	<div id="rstats" class="box">
		<div class="heading">每月带宽监控 <a class="pull-right" href="#" data-toggle="tooltip" title="重新加载信息" onclick="reloadPage(); return false;"><i class="icon-refresh"></i></a></div>
<div class="content">
...
<b>日期</b> <select onchange="changeDate(this, 'ym')" id="dafm"><option value="0">yyyy-mm</option><option value="1">mm-yyyy</option><option value="2">mmm yyyy</option><option value="3">mm.yyyy</option></select> &nbsp;
