...
<content>
	...
	<div class="box" data-box="ctnf-cons">
		<div class="heading">活动连接数 <small>( <font color="red">本页面仅供专家级用户使用 , 故不做太多汉化！以免导致无法上网/游戏 .</font> )</small></div>
		<div class="content">
	...
	<div class="box" data-box="ctnf-nat">
		<div class="heading">追踪 / NAT 助手</div>
	...
	<div class="box" data-box="ctnf-misc"">
		...
		<script type="text/javascript">
			...
			$('.content.misc').forms([
				...
				{ title: '入站7层', name: 'f_l7in', type: 'checkbox', value: nvram.nf_l7in != '0' }
			], { grid: ['col-sm-2', 'col-sm-10'] });
		</script>
