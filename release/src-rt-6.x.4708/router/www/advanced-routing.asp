	...
	<script type="text/javascript">
		...
		ars.setup = function() {
			this.init( 'ars-grid', '', 20, [
				...
				{ type: 'text', maxlen: 3 }, {
					type: 'select', options: [ [ 'LAN', 'LAN' ], [ 'LAN1', 'LAN1' ], [ 'LAN2', 'LAN2' ], [ 'LAN3', 'LAN3' ], [ 'WAN', 'WAN' ], [ 'MAN', 'MAN' ], [ 'WAN2', 'WAN2' ], [ 'MAN2', 'MAN2' ]
						/* MULTIWAN-BEGIN */
		...
		<div class="box" data-box="routing-misc">
			...
			<script type="text/javascript">
				$( '.content.misc' ).forms([
                   ...
                   /* ZEBRA-END */
                   /* EMF-BEGIN */
                   { title: '高效多播转发', name: 'f_emf', type: 'checkbox', value: nvram.emf_enable != '0' },
                   /* EMF-END */
                   { title: 'DHCP路由', name: 'f_dhcp_routes', type: 'checkbox', value: nvram.dhcp_routes != '0' }
	            ]);
			</script>
		</div>
