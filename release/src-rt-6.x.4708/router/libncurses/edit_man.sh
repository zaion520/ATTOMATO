...
(*.[0-9]*)
	...
	if test ! -f /root/advancedtomat/release/src-rt-6.x.4708/router/libncurses/man_alias.sed ; then
cat >>/root/advancedtomat/release/src-rt-6.x.4708/router/libncurses/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /root/advancedtomat/release/src-rt-6.x.4708/router/libncurses/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /root/advancedtomat/release/src-rt-6.x.4708/router/libncurses/man_alias.sed | sort -u; test $inalias = $nCurses && echo curses`
	cf_target=`grep "^$cf_source" /root/advancedtomat/release/src-rt-6.x.4708/router/libncurses/man/man_db.renames | mawk '{print $2}'`
	...
	sed	-f /root/advancedtomat/release/src-rt-6.x.4708/router/libncurses/man_alias.sed \
		< $i | sed -f /root/advancedtomat/release/src-rt-6.x.4708/router/libncurses/edit_man.sed >$TMP
