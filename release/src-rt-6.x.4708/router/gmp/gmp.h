...
#define __GMP_CC "arm-brcm-linux-uclibcgnueabi-gcc -std=gnu99"
#define __GMP_CFLAGS "-Os -Wall -DLINUX26 -DCONFIG_BCMWL5 -DCONFIG_BCMWL6 -DCONFIG_BCMWL6A -DPART_JFFS2_GAP=0UL -pipe -fno-strict-aliasing -DBCMWPA2 -DBCMARM -marm  -DTCONFIG_NVRAM_64K -DLINUX_KERNEL_VERSION=132644 -fPIC -ffunction-sections -fdata-sections"
