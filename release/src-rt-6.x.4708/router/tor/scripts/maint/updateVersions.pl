...
$CONFIGURE_IN = '/root/advancedtomat/release/src-rt-6.x.4708/router/tor/configure.ac';
$ORCONFIG_H = '/root/advancedtomat/release/src-rt-6.x.4708/router/tor/src/win32/orconfig.h';
$TOR_NSI = '/root/advancedtomat/release/src-rt-6.x.4708/router/tor/contrib/win32build/tor-mingw.nsi.in';
